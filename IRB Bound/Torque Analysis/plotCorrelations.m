...
for i = 1:numTrials
    ...
    moment_t = [moment_t; P(1)*250*pre(2)]; %this is assuming that the pre-impact y coordinate is the y-coordinate of the COM at impact **WILL NOT give highly accurate results
