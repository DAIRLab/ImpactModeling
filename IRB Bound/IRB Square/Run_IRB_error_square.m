...
for trials = 1:numTrials
        ...
        [Pre, Post] = ReadData(trials);

        p1 = 1;
        p2 = 1;
        %loop over all values
         [P_old,error_old] = IRB_NEW_torque_old_square(Pre(1,2:7),Post(1,2:7),trials,p1,p2);
         [P,w,error] = IRB_NEW_torque_square(Pre(1,2:7),Post(1,2:7),trials,p1,p2);
         errorP(1:3,tr) = P';
         errorP(4,tr) = error;
         errorP(5,tr) = w;
