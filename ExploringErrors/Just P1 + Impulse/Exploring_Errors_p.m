% Exploring Errors (Px/Py version)

% This function uses the Wang model and finds the best mu and epsilon for
% a specific trial, given p1 and p2.

function [bestEp2,bestMu2,minError,Pfinal] = Exploring_Errors_ind(p1,p2,bounce_array,trial) 
...
for i = 1:iter
    ...
    for j = 1:iter
        ...
        %Run AP Poisson Model given mu and epsilon
         ...
         [v_calc,P] = Wang_juniors(pre,n,d,mu,epsilon,p1,p2);
